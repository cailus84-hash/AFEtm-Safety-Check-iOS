...
const dict = {
  en: {
    ...
    'profile.delete.title': 'Delete my data',
    'profile.delete.body': 'Permanently erase your profile and every assessment.',
    'profile.delete.warn': 'This cannot be undone. Your profile, all assessments and diagnostic traces will be permanently deleted from AFEtm servers.',
    'profile.delete.confirm': 'Delete permanently',
    'profile.delete.cancel': 'Cancel',
    'profile.delete.error': 'Could not delete your data. Check your connection and try again.',
    ...
    'guided.phase.fcp': 'Increase Heart Rate',
    ...
    'guided.fcp.title': 'Increase Heart Rate',
    'guided.fcp.body':
      'Increase your heart rate with a controlled effort. Recovery begins automatically when a valid reading reaches the target.',
    'guided.fcp.rhr': 'RHR',
    'guided.fcp.target': 'Target HR',
    'guided.fcp.live': 'Current HR',
    'guided.fcp.required': 'Recovery cannot begin until the target HR is reached.',
    'guided.fcp.reached': 'Target reached. Stop the effort and sit immediately.',
    'guided.fcp.end': 'End attempt — target HR not reached',
    'guided.recovery.started': 'Recovery started — remain seated and still for 180 seconds.',
    'guided.recovery.complete': 'Recovery complete — HR180 captured ✓',
    'guided.audio.unavailable': 'Sound cues are unavailable. Follow the on-screen stage instructions.',
  ...
  es: {
    ...
    'profile.delete.title': 'Eliminar mis datos',
    'profile.delete.body': 'Borra permanentemente tu perfil y todas tus evaluaciones.',
    'profile.delete.warn': 'Esta acción no se puede deshacer. Tu perfil, todas tus evaluaciones y trazas de diagnóstico se eliminarán permanentemente de los servidores AFEtm.',
    'profile.delete.confirm': 'Eliminar permanentemente',
    'profile.delete.cancel': 'Cancelar',
    'profile.delete.error': 'No se pudieron eliminar tus datos. Revisa tu conexión e inténtalo de nuevo.',
    ...
    'guided.phase.fcp': 'Aumentar frecuencia cardiaca',
    ...
    'guided.fcp.title': 'Aumentar frecuencia cardiaca',
    'guided.fcp.body':
      'Aumenta tu frecuencia cardiaca con un esfuerzo controlado. La recuperación comienza automáticamente cuando una lectura válida alcanza el objetivo.',
    'guided.fcp.rhr': 'FCr',
    'guided.fcp.target': 'FC objetivo',
    'guided.fcp.live': 'FC actual',
    'guided.fcp.required': 'La recuperación no puede comenzar hasta alcanzar la FC objetivo.',
    'guided.fcp.reached': 'Objetivo alcanzado. Detén el esfuerzo y siéntate inmediatamente.',
    'guided.fcp.end': 'Finalizar intento — FC objetivo no alcanzada',
    'guided.recovery.started': 'Recuperación iniciada — permanece sentado y quieto durante 180 segundos.',
    'guided.recovery.complete': 'Recuperación completa — HR180 capturada ✓',
    'guided.audio.unavailable': 'Las señales de sonido no están disponibles. Sigue las instrucciones de cada etapa en pantalla.',
